...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ...
  FutureOr<void> fetchProfileDetails(FetchProfileDetails event, Emitter<ProfileState> emit) async {
  ...
  FutureOr<void> saveProfileDetails(SaveProfileDetails event, Emitter<ProfileState> emit) async{
