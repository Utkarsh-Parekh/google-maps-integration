  ...
  void initState(){
    getUserLoggedIn().whenComplete(() async{
      ...
      Timer(const Duration(seconds: 5),(){
        context.pushNamed(RouteNames.signInRoute,);
      }) : Timer(const Duration(seconds: 5),(){
    ...
    return Scaffold(
      ...
      body: Center(
          child: Column(
            ...
            children: [
              Center(child: Image.asset("lib/assets/demaze_logo.jpeg",width: 300,height: 300),),
              const SizedBox(height: 30,),
              Text("Demaze Technologies",style: GoogleFonts.poppins(fontSize: 30,color: Colors.purple))
            ],
          )
      ),
    );
